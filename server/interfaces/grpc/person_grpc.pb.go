...
func (c *personClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/grpc.Person/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPersonServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Person_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Person/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServer).SayHello(ctx, req.(*HelloRequest))
	}
...
var Person_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "server/interfaces/grpc/person.proto",
}
